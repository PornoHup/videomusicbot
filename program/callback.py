...
async def cbstart(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""🕊️**Merhaba [{query.message.chat.first_name}](tg://user?id={query.message.chat.id}) !**\n
💭 **[{BOT_NAME}](https://t.me/{BOT_USERNAME}) ben Telegram'ın görüntülü sohbetleri aracılığıyla gruplarda müzik ve video oynatmanız için yaratıldım!**
...
💡 **Bu bot hakkında takip eden bir sorunuz varsa, bunu buradaki sohbetime iletebilirsiniz. [👨‍💻](https://t.me/@ruhsuzbeyyy) **
...
async def cbsudo(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""🏮
Üzgünüm bu komutları sadece bot sahibi kullanabilir sen de kendine ait bir bot istiyorsan @ruhsuzbeyyy 'e yazabilirsin...
