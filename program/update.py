...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("♻️ `güncelleme işleniyor...`")
    update_avail = updater()
    if update_avail:
        await msg.edit("✅ güncelleme tamamlandı\n\n• bot yeniden başlatıldı 1 dk sonra yeniden aktif.")
        system("git pull -f && pip3 install -r requirements.txt")
        execle(sys.executable, sys.executable, "main.py", environ)
        return
    await msg.edit("bot şu anda güncel**  [sahip](https://t.me/ruhsuzbeyyy)", disable_web_page_preview=True)
...
async def restart_bot(_, message: Message):
    ...
    await msg.edit("✅ bot yeniden başlatıldı\n\n• artık bu bot'u yeniden kullanabilirsiniz.")
